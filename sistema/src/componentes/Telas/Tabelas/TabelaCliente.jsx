...
export default function TabelaCliente(props){
    ...
    function alterarCliente(clientes){
        props.setClienteSelecionado(clientes);
    ...
    return(
        <>
            <Container>
                            ...
                            props.listaDeCliente?.map((clientes)=>{
                                return(
                                    <tr>
                                        ...
                                        <td>
                                            <Button variant="warning" onClick={()=>{alterarCliente(clientes);}} > <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-square" viewBox="0 0 16 16">
                ...
                <p> Quantidade de cliente(s) cadastrados: {props.listaDeCliente.length}</p>
            </Container>
        </>
    );
}