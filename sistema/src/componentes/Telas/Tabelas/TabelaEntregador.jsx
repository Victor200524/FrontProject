...
export default function TabelaEntregador(props){
    function excluirEntregador(entregador){
        if(window.confirm("Deseja realmente excluir o entregador " + entregador.nome)){
            props.setListaEntregador(props.listaEntregador.filter((item)=>{
    ...
    return(
        <>
            <Container>
                        ...
                        props.listaEntregador?.map((entregador)=>{
                            return(
                                <tr>
                                    ...
                                    <td>
                                            <Button variant="warning" onClick={()=>{alterarEntregador(entregador);}} > <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-square" viewBox="0 0 16 16">
                ...
                <p> Quantidade de entregador(es) cadastrados: {props.listaEntregador.length}</p>
            </Container>
        </>
    )
