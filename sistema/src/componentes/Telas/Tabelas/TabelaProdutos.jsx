...
export default function TabelaProdutos(props) {
  //recuperar o estado da aplicação da fatia produto
  const {estado,mensagem,listaDeProdutos} = useSelector(state=>state.produto);//useSelector manipula o estado e pega a informação de nosso interess
  ...
  if(estado === ESTADO.PENDENTE){
    ...
    return (
      <Container>
        ...
        <p>Quantidade de produto(s) cadastrados: {listaDeProdutos.length}</p>
      </Container>
    );
  }
}
